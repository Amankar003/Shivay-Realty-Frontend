...
export function CTASection() {
  return (
    <section className="dark relative py-24 md:py-32 overflow-hidden border-t border-border bg-background-secondary/50 text-foreground transition-colors duration-500">
      <div className="container-luxury relative z-10">
        <div className="mx-auto max-w-4xl rounded-3xl overflow-hidden relative">
          ...
          <div 
            ...
            style={{ 
              backgroundImage: "url('/images/photo-1512917774080-9991f1c4c750.jpg')",
            }}
          />
          ...
          <div className="relative z-20 flex flex-col p-8 md:p-16">
            <ScrollReveal direction="up" duration={0.6}>
              ...
              <p className="text-foreground-secondary text-lg mb-10 max-w-lg leading-relaxed">
                Schedule a private viewing with our property advisors and experience the Shivaay standard of living.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/contact"
                  className="group inline-flex items-center justify-center gap-2 rounded-md bg-accent-gold px-8 py-4 font-accent text-sm font-medium tracking-wider text-white uppercase transition-transform hover:scale-[1.02] active:scale-95 shadow-gold w-full sm:w-auto"
                >
                  Schedule a Visit
